...
```{r, echo=FALSE,fig.width=6.4,fig.height=6.4}
  ...
  with(ratios, {# this allows entering your commands more succinctly
    ...
    plot(1:nr, boxOdds, ylim = c(0.9990, 1.001), type = 'n', xaxt = 'n', xlab = '', main="Oddskvot och 95% CL för de oberoende variablerna", cex = 25, ylab = 'Oddskvot', frame.plot = TRUE, panel.first = grid(nx = NA, ny = NULL))
